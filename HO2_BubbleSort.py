# Bubble Sort for array size of 5, 10, 20, 100, 500, 1000
...
start = timeit.default_timer()
print(f"Sorted Array: {str(bubbleSort(array_length_100, len(array_length_100)))} within a time of {(timeit.default_timer() - start) * 1000:.2f} milliseconds")
print()
...
start = timeit.default_timer()
print(f"Sorted Array: {str(bubbleSort(array_length_500, len(array_length_500)))} within a time of {(timeit.default_timer() - start) * 1000:.2f} milliseconds")
print()
...
start = timeit.default_timer()
print(f"Sorted Array: {str(bubbleSort(array_length_1000, len(array_length_1000)))} within a time of {(timeit.default_timer() - start) * 1000:.2f} milliseconds")